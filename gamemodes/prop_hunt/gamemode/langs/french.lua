...
-- FULL TRANSLATION AND WAS REDONE BY GALAXIO. Sorry for Tr1N1ty and Heaiven, I'mm too fast :(

-- Originally written by: Fafy
-- Improved by Wolvindra-Vinzuerio & Godfather
-- French Translation rewritted by GaLaxio. (Steam id : Galaxiofr)
...
LANG.Author			= "GaLaxio" -- Only accept STRINGS. (Sorry TR1N1TY and Heaiven, I'm too fast :( )
-- Can Accept: String, and Table.
LANG.AuthorURL		= {	
	"https://steamcommunity.com/id/galaxiofr/"
}
...
LANG["CHAT_SWAPBALANCEYOU"]		= "Vous avez été déplacé dans l'autre équipe pour un équilibrage parfait." -- Smile... for even in death, you have become children of Thanos
